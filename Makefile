...
DIST_SUBDIRS = src/scanbd conf integration scripts contrib doc \
	src/scanbuttond
am__DIST_COMMON = $(srcdir)/Makefile.in AUTHORS compile config.guess \
...
ACLOCAL = ${SHELL} /tmp/xx/1.5.1/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /tmp/xx/1.5.1/missing autoconf
AUTOHEADER = ${SHELL} /tmp/xx/1.5.1/missing autoheader
AUTOMAKE = ${SHELL} /tmp/xx/1.5.1/missing automake-1.15
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /tmp/xx/1.5.1/missing makeinfo
MANIFEST_TOOL = :
...
UDEV_LIBS = 
VERSION = 1.92
abs_builddir = /tmp/xx/1.5.1
abs_srcdir = /tmp/xx/1.5.1
abs_top_builddir = /tmp/xx/1.5.1
abs_top_srcdir = /tmp/xx/1.5.1
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tmp/xx/1.5.1/install-sh
